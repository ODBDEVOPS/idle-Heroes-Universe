...
import { GameService, STANDARD_SUMMON_COST_GOLD, PREMIUM_SUMMON_COST_PRESTIGE } from '../../services/game.service';
import { Hero, Rarity } from '../../models/hero.model';
...
export class SummonComponent implements OnDestroy {
  ...
  standardSummonCost = STANDARD_SUMMON_COST_GOLD;
  premiumSummonCost = PREMIUM_SUMMON_COST_PRESTIGE;
